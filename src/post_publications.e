...
feature -- Execution
	...
	execute (a_start_path: READABLE_STRING_8; req: WSF_REQUEST; res: WSF_RESPONSE)
		...
		do
			create j.make_empty
			if attached {WSF_STRING} req.form_parameter ("year") as year then
				if year.is_integer and then attached year.integer_value as y and then year.integer_value >= 1600 and year.integer_value <= 3000 then
